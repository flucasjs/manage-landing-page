...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1D1E25] flex flex-col lg:grid lg:grid-cols-3 lg:grid-rows-2 lg:place-items-center items-center text-white pt-[3.1875rem] pb-[1.875rem] py-[5.6875rem] lg:py-[3.875rem] xl:py-[4.875rem] lg:px-[10.3125rem]">
      <form className="mb-[3.375rem] flex gap-x-2 text-[#8D8D8D] lg:col-start-3 lg:row-start-1 lg:mb-0 lg:justify-self-end">
        <input
          type="email"
          required
          ...
          className="px-6 py-3 rounded-[22px]"
        />
        <Button type="submit" className="shadow-none">Go</Button>
      </form>
      <ul className="lg:row-span-2 lg:mb-0 flex flex-wrap gap-y-[0.375rem] lg:gap-y-[0.8125rem] gap-x-[6.625rem] text-[0.9375rem] leading-[1.475] -tracking-[0.0165] max-w-[16.5rem] mb-[3.125rem] lg:max-w-[24rem] lg:col-start-2 lg:row-start-1">
        <li className="grow-0 shrink-0 basis-[25%] whitespace-nowrap hover:text-[#F3603C]">
          <Link href="#"> Home</Link>
        </li>
        <li className="grow-0 shrink-0 basis-[25%] whitespace-nowrap hover:text-[#F3603C]">
        ...
        <li className="grow-0 shrink-0 basis-[50%] whitespace-nowrap hover:text-[#F3603C]">
          <Link href="#"> About Us</Link>
        </li>
      </ul>
      <div className="flex gap-x-[2.125rem] mb-[3.375rem] lg:col-start-1 lg:mb-0 lg:self-end lg:justify-self-start">
        <Link href="#">
      ...
      <p className="font-normal text-[0.8125rem] leading-[1.4615] -tracking-[0.015em] opacity-50 lg:col-start-3 lg:self-end lg:justify-self-end">Copyright 2020. All Rights Reserved</p>
    </footer>
  );
}
