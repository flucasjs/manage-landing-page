...
export default function Hero() {
  return (
    <div className="mb-24 flex flex-col items-center px-2 lg:flex-row lg:justify-between lg:px-32 lg:pt-16 xl:max-w-full xl:px-48 2xl:mx-auto 2xl:px-[10rem] 3xl:px-[18rem]">
      <div className="order-1 flex max-w-[500px] flex-1 justify-end 3xl:max-w-full ">
        <Illustration />
      </div>
